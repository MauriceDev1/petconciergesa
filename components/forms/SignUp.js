...
export default function SignUp() {
  ...
  return (
    <div 
    className='flex bg-blue-100 flex-wrap w-full py-6 md:py-9'>
    <div className='flex flex-wrap w-10/12 md:w-7/12 m-auto'>
      <div className='flex w-full'>
        <h1 
            className='text-[23px] md:text-[54px] font-bold m-auto pb-5 sm:pb-3 text-blue-500'>
      ...
      <button 
        className='w-4/12 md:w-3/12 h-10 sm:h-12 rounded-r-lg text-white text-md md:text-xl sm:text-xl bg-blue-500 hover:bg-blue-600'
        onClick={subscribe}
      >
