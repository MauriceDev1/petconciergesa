...
export default function Testimonials() {
  return (
    <div className='flex w-full text-gray-600 py-20'>
        <div className='flex flex-wrap w-10/12 md:w-4/6 m-auto'>
          <h1 
            className='text-4xl md:text-6xl font-bold m-auto'>What Our Clients Have To Say</h1>
          <div className='flex flex-wrap w-full justify-center'>
            <p className='pt-10 italic px-30 text-xl text-gray-500'><span>
